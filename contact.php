...
<head>
    ...
    <title>Apartment Rental - CONTACT</title>
...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    ...
    <p class="text-center mt-3">
      ...
      Incidunt inventore fugiat repellendus harum 
      <br> corrupti quo odio distinctio vel culpa enim 
      quisquam beatae tempore, eligendi, 
      sit aut illo iure, vitae quae.
    </p>
  </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        ...
        <div class="bg-white rounded shadow p-4 ">
          ...
          <a href="mailto: razafindrazakav@gmail.com" class="d-inline-block text-decoration-none text-dark">
            <i class="bi bi-envelope-fill"></i> razafindrazakav@gmail.com
          </a>
        ...
        <div class="bg-white rounded shadow p-4">
          <form>
            ...
            <div class="mt-3">
              ...
              <textarea class="form-control shadow-none" rows="5" style="resize: none;"></textarea> </textarea>
            </div>
            <button type="submit" class="btn text-white custom-bg mt-3">SEND</button></button>
          </form>
        </div>
      </div>
